...
export default (() => {
	return <Theme theme={theme}>
		...
		<Section
			...
			sm-padding="40px 0"
			position="relative"
			background="linear-gradient(0deg,rgba(25, 30, 34, 0.8) 0%,rgba(25, 30, 34, 0.8) 100%),--color-darkL2 url(https://uploads.quarkly.io/5fbea2d48996cc001edd3ad5/images/Rosatom1.jpg?v=2020-11-25T19:27:41.573Z)"
		>
			<Stack>
